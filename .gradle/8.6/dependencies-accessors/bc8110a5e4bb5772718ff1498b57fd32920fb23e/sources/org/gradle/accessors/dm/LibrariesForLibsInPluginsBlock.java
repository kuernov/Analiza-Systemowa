...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final JhipsterLibraryAccessors laccForJhipsterLibraryAccessors = new JhipsterLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>jhipster</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public JhipsterLibraryAccessors getJhipster() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForJhipsterLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class JhipsterLibraryAccessors extends SubDependencyFactory {

        public JhipsterLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>dependencies</b> with <b>tech.jhipster:jhipster-dependencies</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getDependencies() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("jhipster.dependencies");
        }
